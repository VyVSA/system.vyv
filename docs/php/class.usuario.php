<?php
	...
	class Usuario{
		...
		function __construct10($id, $documento, $nombre, $apellido, $celular, $correo, $direccion, $contrasenha, $estado, $perfil){
			$this -> id = $id;
		...
		function __construct7($documento, $nombre, $apellido, $celular, $correo, $direccion, $contrasenha){
			$this -> documento = $documento;
			$this -> nombre = $nombre;
			$this -> apellido = $apellido;
			$this -> celular = $celular;
